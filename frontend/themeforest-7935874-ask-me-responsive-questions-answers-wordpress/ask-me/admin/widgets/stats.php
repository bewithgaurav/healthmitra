		...
		$best_answer_option = get_option("best_answer_option");
			...
			<div class="widget_stats ul_list ul_list-icon-ok">
				<ul>
					...
					<li><i class="icon-comments"></i><?php _e("Best Answers","vbegy")?> ( <span><?php echo (isset($best_answer_option) && $best_answer_option != "" && $best_answer_option > 0?$best_answer_option:0)?></span> )</li>
