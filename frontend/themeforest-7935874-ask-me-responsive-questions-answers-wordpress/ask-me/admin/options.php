...
function optionsframework_options() {
	...
	$export = array(vpanel_options,"sidebars","badges","roles");
	...
	$options[] = array(
		'name' => 'Note: this options work in the home page only and if you don\'t choose the Front page. - W  P  L  O  C  K  E  R  . C  O  M',
	...
	$options[] = array(
		'name' => 'All the site for the register users only ? - W/P/L/O/C/K/E/R/./C/O/M',
	...
	$options[] = array(
		'name' => "Advertising after content W-P-L-O-C-K-E-R-.-C-O-M",
		'class' => 'home_page_display',
		'type' => 'info');
