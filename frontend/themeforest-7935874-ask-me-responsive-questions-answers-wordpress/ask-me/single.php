	...
	if ( have_posts() ) : while ( have_posts() ) : the_post();
		...
		<article <?php post_class('post single-post');?> id="post-<?php the_ID();?>" role="article" itemscope="" itemtype="http://schema.org/Article">
			<div class="post-inner">
				<div class="post-img<?php if (($vbegy_what_post == "image" && !has_post_thumbnail()) || !has_post_thumbnail() || ($featured_image == 1 && is_singular())) {echo " post-img-0";}else if ($vbegy_what_post == "lightbox") {echo " post-img-lightbox";}else if ($vbegy_what_post == "video") {echo " video_embed";}if ($vbegy_sidebar_all == "full") {echo " post-img-12";}else {echo " post-img-9";}?>">
